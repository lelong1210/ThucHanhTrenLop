                ...
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="./"><img src="./public/images/logo/logo.jpg" alt="Site Logo" class="imgLOGO" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                    ...
                    <div class="col align-self-center">
                        <div class="header-actions">
                            ...
                            <!-- Single Wedge End -->
                            <a href="./giohang" class="header-action-btn header-action-btn-cart">
                        ...
                        <div class="main-menu manu-color-white">
                            <ul>
                                ...
                                <li class="dropdown"><a href="#">Sản Phẩm<i class="ion-ios-arrow-down"></i></a>
                                    <ul class="sub-menu">
                                        <li><a href="./khoacuathongminh">Khóa Cửa Thông Minh</a></li>
                                        <li><a href="./mayhutbui">Máy Hút Bụi</a></li>
                                        <li><a href="./dieuhoathongminh">Điều Hòa Thông Minh</a></li>
                                        <li><a href="./denthongminh">Đèn Thông Minh</a></li>
