...
<body>
    <div class="header">
    <div id="NutThanhToan" class="NutThanhToan container text-center">
        <div class="quayve text-success"><h1 style="color: teal;"><a href="../">QUAY VỀ</a></h1></div>
        <div class="quayve text-success"><h1 style="color: teal;"><a href="../giohang/gh">GIỎ HÀNG</a></h1></div>
    </div>
    </div>
    <div class="content">
    ...
    <div id="ShowTable" class="container text-center"></div>
    <div class="footer"></div>
    <div class="test"><button id="test">test</button></div>
</body>
